...
node_set_left (node: &node_t (a, b) >> node_t (a, b), left: node_t (a, b)): node_t (a, b) = let
	val- node_cons (data, key, parent, child, old_left, right, degree, marked) = node
...
node_set_right (node: &node_t (a, b) >> node_t (a, b), right: node_t (a, b)): node_t (a, b) = let
	val- node_cons (data, key, parent, child, left, old_right, degree, marked) = node
	val () = node := node_cons (data, key, parent, child, left, right, degree, marked)
in
	old_right
end
...
node_set_parent (node: &node_t (a, b) >> node_t (a, b), parent: node_t (a, b)): node_t (a, b) = let
	val- node_cons (data, key, old_parent, child, left, right, degree, marked) = node
	val () = node := node_cons (data, key, parent, child, left, right, degree, marked)
in
	old_parent
end
...
node_set_chlid (node: &node_t (a, b) >> node_t (a, b), child: node_t (a, b)): node_t (a, b) = let
	val- node_cons (data, key, parent, old_child, left, right, degree, marked) = node
	val () = node := node_cons (data, key, parent, child, left, right, degree, marked)
in
	old_child
end
...
fun {a, b: t@ype}
heap_set_root (heap: &heap_t (a, b) >> heap_t (a, b), node: node_t (a, b)): node_t (a, b)
